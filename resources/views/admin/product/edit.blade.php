    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="page-header">
                <h3 class="page-title"> Edit {{ $product->name }} product </h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active" aria-current="page">Products</li>
                        <li class="breadcrumb-item active" aria-current="page">Edit {{ $product->name }} product</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" method="POST" action="{{ URL('product/update/' . $product->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" placeholder="Name" name="name" value="{{ $product->name }}">
                                    @error('name')
                                ...
                                <div class="form-check form-check-primary mb-3">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="is_discount"
                                            @if ($product->is_discount) checked @endif> Has Discount?
                                    </label>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text"
                                            ...
                                            disabled="" placeholder="Upload Image" value="{{ $product->photo }}">
